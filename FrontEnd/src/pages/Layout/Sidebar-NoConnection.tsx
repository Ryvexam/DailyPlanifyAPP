...
const Header = (
  ...
  return (
    <header className="sticky top-0 z-999 flex flex-grow w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center  justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">


        <Link className="block flex-shrink-0 max-sm:hidden" to="/">
